 ...
 * @author skuarch
 */
public class FirewallStatus extends ActionSupport {
    
    private static final Logger logger = Logger.getLogger(FirewallStatus.class);
    ...
    public String execute() throws Exception {
        ...
        try {
            ...
            if(returnedJson.getBoolean("changed")){
                message = getText("text.14");
            }else{
