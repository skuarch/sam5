 ...
 * @author skuarch
 */
public class TaskSettingsTable extends ActionSupport{

    private static final Logger logger = Logger.getLogger(TaskSettingsTable.class);    
    ...
    public String execute() throws Exception {
        ...
        try {
            ...
            if (JSONUtilities.checkErrorJson(returnedJson)) {
                ...
                ids = JSONUtilities.jsonArrayToArrayList(returnedJson.getJSONArray("ids"));
